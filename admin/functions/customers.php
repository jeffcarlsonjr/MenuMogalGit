...
function show_image($cust_id){
	   ...
	   $a = 0;
		...
		while ($path = mysql_fetch_array($result)){
		  ...
		  <td><a href="admin/uploads/<?=$path[0]?>" class="highslide" onclick="return hs.expand(this)" title="Click to enlarge"><img src='admin/uploads/<?=$path[0] ?>' width='125px' height='125px' border="0"></a><br /></td>
