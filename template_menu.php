...
<?=$state?>
  ...
  <div id="rt">
    ...
    <div id="feature">      
    <div id="menuimage"><img src="<?php echo "admin/uploads/".$pic.""; ?>" alt="<?=$name?>" title="<?=$name?>" name="image_place" width="200" height="200" id="image_place" style="background-color: #CCCCCC" /></div>      <div id="menuinfo">
