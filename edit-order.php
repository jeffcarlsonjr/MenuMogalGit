...
if (!empty($_POST['process'])) {
	add_billing_address($cust_id_fk);
}
...
if (!empty($_POST['process'])) {
	...
	$auth_return=cc_process($card_number,$card_exp,$cc_avs,$firstname,$lastname,$billing_address,$billing_state,$billing_zip,$billaddr_email,$order_amount,$order_id);
	echo "&nbsp;&nbsp;&nbsp;&nbsp;".$auth_return[3];
}
					...
					<tr>
						<td valign="top">
							...
							<form method="post">
                                ...
                                <option value="26212" <?php if ("26212" == $addr_id_fk) {echo " selected";}?>>Pick Up Academy</option>
<?php
...
<?php } ?>
  ...
  <tr>
									...
									<select name="billing_cc_type" onchange="amex_show();" >
                                    ...
                                    <option value="AMEX" <?php if($cc_type =='AMEX') {selected();}?>>AMEX</option>
                                  </select>										                                 </td>
								</tr>
                                <tr>
								...
								<tr>
                                    ...
                                    <td> 
                                    	<!--<input name="billing_cc_num" type="text" class="large" style="width:175px;"/>-->
                             		 <div id="cc">
                                        ...
                                        <input type="text" name="cc4" maxlength="4" size="3" 
                                        	    onkeyup="autofocus(this, 4, 'billing_cc_month', event)"/>
									</div>

									                                              
									<div id="amex" class="hide">
									 	<input type="text" name="amexcc1" maxlength="4" size="3" 
                                        	   onkeyup="autofocus(this, 4, 'amexcc2', event)"/> -
                                        <input type="text" name="amexcc2" maxlength="4" size="3" 
                                        	   onkeyup="autofocus(this, 4, 'amexcc3', event)"/> -
                                        <input type="text" name="amexcc3" maxlength="4" size="3" 
                                        	   onkeyup="autofocus(this, 4, 'amexcc4', event)"/> -
                                        <input type="text" name="amexcc4" maxlength="3" size="3" 
                                        	    onkeyup="autofocus(this, 4, 'billing_cc_month', event)"/>
									</div> 
                                ...
                                <tr>
                                    ...
                                    <td><div id="amex2" class="hide"><input name="billing_cc_avs" type="text" size="3" maxlength="4"/></div>
                                    <input name="billing_cc_avs" type="text" size="3" maxlength="3"/></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td><input type="submit" value="Update CC Info"/>&nbsp;&nbsp;<input type="submit" value="Process" name="process"/></td>
                                </tr>
							</table>
                            </form>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="billing_name" class="big" onchange="autofocus(this,'cc1', event)"
                        		value="<?php  echo $billaddr_name;?>" /></td>
                    <tr>
                    <tr>
                      <td><div id="table-header-text">Card Number:</div></td>
                      <td>
                    ...
                    <tr>
                      <td><input type="button" value="Submit" name="process" /></td>
                      <td>&nbsp;</td>
                    </tr>
                  </table>
							</form>
                                  ...
                                  <tr>
                                    <td><form method="post" action="customer_email.php?order_id=<?=$order_id;?>"  target="_parent">
                                      ...
                                      <select name="email_type" onchange="this.form.submit()" style="width:175px" >
                                        ...
                                        <option value="confirmrecvd">Confirmation Received</option>
                                      </select>
