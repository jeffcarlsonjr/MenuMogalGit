...
<div id="displayarea">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td valign="top" scope="col"><div class="leftspace">
        <div class="toplistarea">Content for  class "toplistarea" Goes Here</div>
      </div></td>
      <td valign="top" scope="col"><div class="rightspace">
        <div class="feature">Content for  class "feature" Goes Here</div>
        <div class="skyscraper_rt">Content for  class "skyscraper_rt" Goes Here</div>
  		<div class="results"><?php $search = clean_input($_POST['search']);?> 
