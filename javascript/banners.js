...
var settings = {
	...
	'img_height':			480, 			// 	height to resize all banners to, only takes effect if above is 1
	
	'refresh_time':			30000,			//	the seconds between refreshs of the banners - use 0 to disable
...
var banners = [
	new banner('AwesomeStyles',			'http://www.awesomestyles.com', 			'ads/4.jpg', 	'30/04/2019',	'top'),
	new banner('Just Free Templates',	'http://www.justfreetemplates.com', 		'ads/5.jpg',		'10/04/2019',	'top'),
	new banner('Flashden', 				'http://www.flashden.net/?ref=spykawg', 	'ads/3.jpg',		'30/04/2019',	'top'),
	new banner('ThemeForest', 			'http://www.themeforest.net/?ref=spykawg', 	'ads/2.jpg', 	'10/04/2019',	'top'),
	new banner('GraphicRiver', 			'http://www.graphicriver.net/?ref=spykawg', 'ads/1.jpg', 	'30/04/2019',	'top'),
	new banner('Dreamhost',				'http://www.dreamhost.com/r.cgi?259541',	'ads/6.gif',		'30/04/2019',	'')
]
